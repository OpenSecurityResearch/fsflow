...
public class Test {
  ...
  public static void main(String[] args) {
    ...
    FlowBlock flowBlock = FlowBlock.from("FlowBlock1", Lists.newArrayList(flow1, flow2, flow3));
    
    List<String> objectives = Lists.newArrayList("Username", "Password", "PIN");
    CallFlow flow = CallFlow.from("UserCantLogIntoWebsite", Lists.newArrayList(objectives), blocks, flowBlock);    
